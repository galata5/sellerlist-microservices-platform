...
public class CredentialResource {
	...
	public ResponseEntity<AuthCredentialDto> findAuthByUsername(
			@PathVariable("username")
			@NotBlank(message = "Input must not blank")
			@Valid final String username) {
		log.info("*** AuthCredentialDto, resource; fetch credential for authentication *");
		return ResponseEntity.ok(this.credentialService.findAuthByUsername(username));
	}
