...
import com.sellerlist.app.exception.wrapper.AddressNotFoundException;
...
import com.sellerlist.app.exception.wrapper.VerificationTokenNotFoundException;
...
public class ApiExceptionHandler {
	...
	public ResponseEntity<ExceptionMsg> handleHandlerMethodValidation(
			final HandlerMethodValidationException error) {
		final String message = error.getAllValidationResults().stream()
