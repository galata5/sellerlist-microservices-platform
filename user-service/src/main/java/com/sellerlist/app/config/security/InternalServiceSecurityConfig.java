package com.sellerlist.app.config.security;
...
public class InternalServiceSecurityConfig {
	...
	public FilterRegistrationBean<InternalServiceAuthenticationFilter> internalServiceAuthenticationFilter(
		...
		final FilterRegistrationBean<InternalServiceAuthenticationFilter> registrationBean = new FilterRegistrationBean<>();
		registrationBean.setFilter(new InternalServiceAuthenticationFilter(
				internalTokenService,
				Set.of("/api/users/register")));
